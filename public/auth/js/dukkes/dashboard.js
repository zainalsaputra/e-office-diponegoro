$(document).ready(function () {
    ...
    function chart1(seldik) {
        $("#seldik-ms").parent('a').attr('href', `/dukkes/seldik/filter/${seldik}/MS`);
        $("#seldik-tms").parent('a').attr('href', `/dukkes/seldik/filter/${seldik}/TMS`);
        $("#seldik-th").parent('a').attr('href', `/dukkes/seldik/filter/${seldik}/TH`);

        $.ajax({
            type: "get",
            url: "/dukkes/chart-seldik",
            data: {id: seldik},
            dataType: "json",
            beforeSend: function () {
                $("#seldik-ms").html("0");
    ...
    function chart2(werving) {
        $("#werving-ms").parent('a').attr('href', `/dukkes/werving/filter/${werving}/MS`);
        $("#werving-tms").parent('a').attr('href', `/dukkes/werving/filter/${werving}/TMS`);
        $("#werving-th").parent('a').attr('href', `/dukkes/werving/filter/${werving}/TH`);

        $.ajax({
            type: "get",
            url: "/dukkes/chart-werving",
            data: {id: werving},
            dataType: "json",
            beforeSend: function () {
                $("#werving-ms").html("0");
    ...
    function chart3(balak) {
        ...
        $("#balak-1").parent('a').attr('href', `/dukkes/balak/filter/${balak}/I`);
        $("#balak-2").parent('a').attr('href', `/dukkes/balak/filter/${balak}/II`);
        $("#balak-3").parent('a').attr('href', `/dukkes/balak/filter/${balak}/III`);
        $("#balak-4").parent('a').attr('href', `/dukkes/balak/filter/${balak}/IV`);

        $.ajax({
            type: "get",
            url: "/dukkes/chart-balak",
            data: {id: balak},
            dataType: "json",
            beforeSend: function () {
                $("#balak-1").html("0");
    ...
    function chart4(prapurna) {
        ...
        $("#prapurna-1").parent('a').attr('href', `/dukkes/prapurna/filter/${prapurna}/I`);
        $("#prapurna-2").parent('a').attr('href', `/dukkes/prapurna/filter/${prapurna}/II`);
        $("#prapurna-3").parent('a').attr('href', `/dukkes/prapurna/filter/${prapurna}/III`);
        $("#prapurna-4").parent('a').attr('href', `/dukkes/prapurna/filter/${prapurna}/IV`);

        $.ajax({
            type: "get",
            url: "/dukkes/chart-prapurna",
            data: {id: prapurna},
            dataType: "json",
            beforeSend: function () {
                $("#prapurna-1").html("0");
